...
class UsersController extends Controller
{
    ...
    {
        $roles = Role::all();
        $groupings = \App\Models\Grouping::all();
       ...
       <table id='data-table' class='table table-bordered table-striped responsive text-center data-table'
        ...
        if ($request->ajax()) {
            ...
            return view('FrontEnd.Users.index', compact('output', 'roles', 'groupings', 'shifts'));
        }
    }
    ...
    public function add_permission_to_users($id)
    {
        ...
        $rolePermission = DB::table("model_has_permissions")
            ...
            ->all();
        return view('FrontEnd.Users.roles', compact('id', 'permissions', 'rolePermission'));
    }
