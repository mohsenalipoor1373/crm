...
namespace App\Http\Controllers\BackEnd\EssentialsDealers;

use App\Http\Controllers\Controller;
use App\Models\EssentialsDealers;
    ...
    public function index(Request $request)
    {
       ...
       <table id='data-table' class='table table-bordered table-striped text-center data-table' style='width:100%'>
        ...
        if ($request->ajax()) {
            ...
            return view('FrontEnd.EssentialsDealers.index', compact('output', 'essentials_packings'));
        }
    }
