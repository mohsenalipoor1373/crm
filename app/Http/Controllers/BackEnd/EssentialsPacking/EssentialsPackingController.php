...
namespace App\Http\Controllers\BackEnd\EssentialsPacking;

use App\Http\Controllers\Controller;
use App\Models\EssentialsPacking;
use App\Models\EssentialsPackingType;
    ...
    public function index(Request $request)
    {
       ...
       <table id='data-table' class='table table-bordered table-striped text-center data-table' style='width:100%'>
        ...
        if ($request->ajax()) {
            ...
            return view('FrontEnd.EssentialsPacking.index', compact('output', 'essentials_packing_types'));
        }
    }
