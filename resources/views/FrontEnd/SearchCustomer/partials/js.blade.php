                ...
                success: function (data) {
                    ...
                    for (i = 0; i < data.events_customers_attach.length; i++) {
                        ...
                        var mockFile = {
                            ...
                            width: '100px',
                            type: '',
                            viewLink: "/public/events_customers_attach/" + data.events_customers_attach[i].file,
                            nominationId: '',
                            id: '',
                            media: "",
                        ...
                        myDropzone_edit.emit("thumbnail", mockFile, `{{ asset('/public/events_customers_attach/') }}${asset_file}`);
                ...
                success: function (data) {
                    ...
                    for (i = 0; i < data.events_customers_detail_attach.length; i++) {
                        ...
                        var mockFile = {
                            ...
                            width: '100px',
                            type: '',
                            viewLink: "/public/events_customers_detail_attach/" + data.events_customers_detail_attach[i].file,
                            nominationId: '',
                            id: '',
                            media: "",
                        };
                        myDropzone_edit_detail.emit("addedfile", mockFile);
                        myDropzone_edit_detail.emit("thumbnail", mockFile, `{{ asset('/public/events_customers_detail_attach/') }}${asset_file}`);
