<div class="modal fade" id="add-stores_type" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" enctype="multipart/form-data" role="form"
                              autocomplete="off" id="form_add_stores_type">
                            @csrf
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="username">نام انبار</label>
                                    <input type="text" class="form-control"
                                           id="name" name="name" placeholder="نام انبار">
                                </div>
            ...
            <div class="modal-footer">
                ...
                <a id="btn_add_stores_type" class="btn btn-primary btn_add_stores_type">ثبت</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<div class="modal fade" id="edit-stores_type" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #e9e9e9;border-bottom-color:#dddddd;cursor: move">
                <button type="button" style="background-color: red" class="close" data-dismiss="modal"
            ...
            <div class="modal-body">
                ...
                <div id="ajaxContentDemo" class="row d-none">
                    <div class="col-md-12">
                        <form method="POST" enctype="multipart/form-data" role="form"
                              autocomplete="off" id="form_edit_stores_type">
                            @csrf
                            <input type="hidden" id="id" name="id">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="edit_username">نام انبار</label>
                                    <input type="text" class="form-control"
                                           id="edit_name" name="edit_name" placeholder="نام انبار">
                                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">انصراف</button>
                <a id="btn_edit_stores_type" class="btn btn-primary btn_edit_stores_type">ثبت</a>
            </div>
        </div>
    </div>
</div>
