...
@section('content')
    ...
    <div style="margin-top: 3%">
        <form method="POST" enctype="multipart/form-data" role="form"
              autocomplete="off" id="form_add_permission_users">
            @csrf
        ...
        <div class="col-md-12" style="margin-top: 3%">
            <a id="btn_add_permission_users" class="btn btn-primary btn_add_permission_users">ثبت</a>
            <a class="btn btn-danger" href="{{route('users_index')}}">بازگشت</a>
        </div>
    </div>
